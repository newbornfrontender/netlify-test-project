      ...
      var a,
        u = {
          adapter: ('undefined' != typeof XMLHttpRequest
            ? (a = r(20))
            : 'undefined' != typeof process && (a = r(25)),
          a),
          transformRequest: [
            function(e, t) {
              return (
      ...
      const s = (e, t, r) => {
        ...
        'GET' == e.httpMethod &&
          (() =>
            o.a
              .get(
                'https://api.github.com/users?client_id=6e91ba0560e2f523d3d1&client_secret=6ea1b0850d49e51412cd810f5a75a9000b534b7c',
              )
              .then(({ data: e }) => n(e))
              .catch((e) => n(e)))();
      };
      ...
      e.exports = function(e) {
        return new Promise(function(t, r) {
          ...
          if (!E && !1 !== E) {
            ...
            if (A) {
              var B = f.parse(A);
              if (((E = { host: B.hostname, port: B.port }), B.auth)) {
                var T = B.auth.split(':');
                E.auth = { username: T[0], password: T[1] };
              }
            }
          }
          if (
            ...
            F.headers['Proxy-Authorization'] = 'Basic ' + j;
          }
          e.transport
            ? (_ = e.transport)
            : 0 === e.maxRedirects
